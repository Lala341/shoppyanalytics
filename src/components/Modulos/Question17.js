...
<h1 style={{paddingBottom: "5%", paddingLeft: "10%", color:"grey"}}>17. People in a store in real time.</h1>  
...
<BarChart
      ...
      >
        ...
        <Bar dataKey="current_users" fill={this.getRandomColor()} />
...
export default withStyles(NoEncontradoStyles)(Question17);
